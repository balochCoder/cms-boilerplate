        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                            <h4 class="mb-sm-0 font-size-18">{{ __('Edit User') }}</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <form action="{{route('users.update',$user->id)}}" class="needs-validation" method="POST" novalidate>
                            @csrf
                            @method('PUT')
                            <div class="col-sm-12">
                                <div class="card">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" name="name" id="name"
                                                        placeholder="Last Name" value="{{ $user->name }}" required>
                                                    <div class="invalid-feedback">
