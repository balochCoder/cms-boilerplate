    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">{{ __('Add Faq') }}</h4>
            ...
            <div class="row">
                ...
                <form class="needs-validation" method="POST" action="{{route('faqs.store')}}"
                     novalidate>
                    <div class="row">
                        @csrf
                        <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select" data-placeholder="Choose Pages" id="page"
                                                    ...
                                                    @forelse ($pages as $page)
                                                        <option value="{{ $page->slug }}">{{ Str::ucfirst($page->name) }}
                                                        </option>
                                                    @empty
                                        ...
                                        <div class="col-sm-8">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="question" id="question"
                                                    placeholder="Question here" value="{{old('question')}}" required>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea rows="4" class="form-control" name="answer" id="answer"
